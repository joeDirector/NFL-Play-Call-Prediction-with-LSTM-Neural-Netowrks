    ...
    \section{Introduction}
        ...
        \subsection{Background}
            ...
            \paragraph{}
                ...
                The two teams on either side of the ball are allowed to reposition themselves and prepare betweeen these instances. 
        ...
        \end{multicols*}
            ...
            \begin{tabular}{|| m{4cm} | m{10cm}| m{2cm} ||} 
                ...
                \hline
                Pass to run ratio & Current proportion of passes used to total plays & Numeric \\
                \hline
    ...
    \section{Methodology}
        ...
        \vspace{-10pt} 
            ...
            \paragraph{}
                ...
                For the cumulative pass to run ratio, we group the data by offensive team and calculate a running total of passes used divided by total plays. 
        ...
        \subsection{Exploratory Analysis}
            ...
            \subsubsection*{Features}
                \paragraph{}
                    ...
                    A possible explanation is that passes are being used on third and short when the offensive team already knows it is going to go for it on fourth down (if the third down pass attempt fails). 
                ...
                \paragraph{}
                    ...
                    This binary feature tells whether the hurry-up offense is being used. 
                    ...
                    Figure 4 confirms what is expected. 
                    ...
                    It is suspected more runs are used in this scenario because they are occurring in normal game conditions (i.e. not with little time remaining, down by many points). 
                ...
                \paragraph{}
                    ...
                    Passes seem to be called overwhelmingly with fewer than 500 seconds remaining in the game when a team is down by 0-20 points. 
        ...
        \subsection{Sequential Models}
            ...
            \begin{multicols*}{2}
                ...
                \paragraph{}
                    ...
                    Many such aspects of the model topology are treated as hyperparameters, as will be discussed later.
                ...
                \paragraph{}
                    ...
                    This process will repeat for a pre-specified number of epochs or until a stopping criterion is met.
                    Typically, this criterion is to stop when the cost function has not reduced over a given number of epochs. 
            ...
            \subsubsection*{LSTM Neural Networks}
                \paragraph{}
                    ...
                    \paragraph{} 
                        ...
                        The structure of a sequential model, whether LSTM or RNN, is tuned via various hyperparameters.
        ...
        \subsection{Baseline Models}
            ...
            \subsubsection*{Gradient Boosted Decision Trees}
                ...
                \paragraph{}
                    ...
                    This is done by minimizing $\gamma$ over the sum of the cost function across $N$: $$M_0 = \argminB_\gamma \sum_{i=1}^N C(y_i, \gamma)$$ 
                    ...
                    \begin{enumerate}
                        ...
                        \item Calculate output values in the new decision tree $\gamma_j = \argminB_\gamma \sum_{i=1}^N C(y_i, M_{j-1}(X_i) + \gamma h_j(X_i))$. 
                ...
                \paragraph{}
                    ...
                    Penalization constrains the parameters during optimization and forces the algorithm to favor simpler models, which helps if the model overfits. 
        ...
        \subsection{Tuning Algorithm}
            ...
            \paragraph{}
                ...
                The top half performing combinations are chosen to continue training for more iterations and the rest are discarded.
            ...
            \paragraph{}
                In order to scale up the tuning process, free to use computing resources were provisioned from Google Cloud Platform.
    ...
    \section{Results}
        ...
        \subsection{Cross Validation Metrics}
            ...
            \paragraph{}
                ...
                Even though its final test metric is slightly worse, the logistic regression model may be preferred over GBDT as its metrics remain steady over the folds. 
        ...
        \subsection{Model Application - Red Zone}
            ...
            \paragraph{}
                ...
                Converting red zone plays into touchdowns is critical for the offensive team.
                Likewise, it is critical for the defensive team to force the offensive team into a field goal attempt.
